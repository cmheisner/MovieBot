...
class BotConfig:
    ...
    bathroom_channel_id: int = 0
    suggestions_channel_id: int = 0
    concessions_channel_id: int = 0
    omdb_api_key: str = ""
    ...
    def from_env(cls) -> "BotConfig":
        ...
        return cls(
            ...
            bathroom_channel_id=int(os.environ.get("BATHROOM_CHANNEL_ID", "0")),
            suggestions_channel_id=int(os.environ.get("SUGGESTIONS_CHANNEL_ID", "0")),
            concessions_channel_id=int(os.environ.get("CONCESSIONS_CHANNEL_ID", "0")),
